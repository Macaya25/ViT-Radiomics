...
if __name__ == "__main__":
    features_folder = '../../../Data/PET-CT/data/features'#'features_medsam'
    ...
    hdf5_pet_path = os.path.join(features_folder, f'features_masks_{modality_a}.hdf5')
    hdf5_ct_path = os.path.join(features_folder, f'features_masks_{modality_b}.hdf5')
    df_path = os.path.join(features_folder, 'petct.parquet')
